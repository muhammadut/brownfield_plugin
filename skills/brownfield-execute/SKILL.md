...
Read `.brownfield/workstreams/<id>/plan.md`.
...
Check: does `.brownfield/workstreams/<id>/build-log.md` exist?
...
Create `.brownfield/workstreams/<id>/build-log.md`:
...
```
You are implementing Task {N.M} from a Brownfield execution plan.
