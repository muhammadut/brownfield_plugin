...
- `.brownfield/workstreams/<id>/plan.md` — the implementation plan
- `.brownfield/workstreams/<id>/build-log.md` — build output and task completion notes
- `.brownfield/workstreams/<id>/verification.md` — adversarial review findings
...
- `.brownfield/learning/codebase-patterns.md`
- `.brownfield/learning/lessons-learned.md`
...
Create the `.brownfield/learning/` directory if it does not exist:

```
mkdir -p .brownfield/learning
```

### Update `codebase-patterns.md`

Append new codebase patterns to `.brownfield/learning/codebase-patterns.md`.
...
Append new lessons to `.brownfield/learning/lessons-learned.md`.
...
- Set the workstream status to `archived` in `.brownfield/workstreams/<id>/state.json`.
