...
5. **Prior Agent Outputs** -- paths to researcher, expert-researcher, and pattern-detector output files in `.brownfield/workstreams/<id>/agent-outputs/`. Read these BEFORE starting exploration — they tell you what patterns to look for and what recommendations are being made.
6. **Output Path** -- the absolute path where you must write your findings (e.g., `.brownfield/workstreams/<id>/agent-outputs/04-code-explorer.md`).
...
- `.brownfield/workstreams/<id>/agent-outputs/01-researcher.md` — industry patterns and methodologies
- `.brownfield/workstreams/<id>/agent-outputs/02-expert-researcher-*.md` — domain guidance
- `.brownfield/workstreams/<id>/agent-outputs/03-pattern-detector.md` — repo conventions + divergence report
